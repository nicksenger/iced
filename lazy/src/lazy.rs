...
pub struct Lazy<'a, Message, Renderer, Dependency, Output, View> {
...
impl<'a, Message, Renderer, Dependency, Output, View>
    Lazy<'a, Message, Renderer, Dependency, Output, View>
where
    Dependency: Hash + 'a,
    Output: 'static,
...
impl<'a, Message, Renderer, Dependency, Output, View> Widget<Message, Renderer>
    for Lazy<'a, Message, Renderer, Dependency, Output, View>
where
    Output: 'static,
    View: Into<Element<'a, Message, Renderer>> + 'a,
    Dependency: Hash + 'a,
...
impl<'a, Message, Renderer, Dependency, Output, View>
    From<Lazy<'a, Message, Renderer, Dependency, Output, View>>
...
{
    fn from(
        cached: Lazy<'a, Message, Renderer, Dependency, Output, View>,
    ) -> Self {
        Self::new(cached)
    }
}
