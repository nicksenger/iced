...
{
    fn diff_self(&self) {
        self.with_element_unchecked(|element| {
            self.tree
                .borrow_mut()
                .borrow_mut()
                .as_mut()
    ...
    fn with_element_unchecked<T>(
        &self,
        f: impl FnOnce(&Element<'_, Event, Renderer>) -> T,
    ) -> T {
        self.with_element_mut_unchecked(|element| f(element))
    }

    fn with_element_mut_unchecked<T>(
        &self,
        f: impl FnOnce(&mut Element<'_, Event, Renderer>) -> T,
    ) -> T {
        self.state
    ...
    Renderer: iced_native::Renderer,
{
    ...
    fn on_event(
        ...
        self.rebuild_element_if_necessary();
        let event_status = self.with_element_mut_unchecked(|element| {
